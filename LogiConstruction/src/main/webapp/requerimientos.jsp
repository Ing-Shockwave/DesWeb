...
<main class="req-main">
    ...
    <section class="req-body">
        ...
        <div class="req-form-card">
            ...
            <form action="RequerimientoServlet" method="post" class="req-form">

                <div>
                    <label>Nombre del Material</label>
                    <input type="text" name="nombre" placeholder="Ej. Cemento Portland" required>
                </div>

                <div>
                    <label>Área Solicitante</label>
                    <input type="text" name="area" placeholder="Almacén Central" required>
                </div>
            ...
            %>
                <p class="req-error">Error al registrar requerimiento</p>
            <%
                }
            %>
        ...
        <div class="req-table-card">
            ...
            <table class="req-table" id="tablaRequerimientos">
                <tr>
                    <th>ID</th>
...
<script>
document.getElementById('buscarRequerimientos').addEventListener('keyup', function() {
    const texto = this.value.toLowerCase();
    const filas = document.querySelectorAll('#tablaRequerimientos tr:not(:first-child)');
